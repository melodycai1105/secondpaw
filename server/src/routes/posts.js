...
import { getPostsBySearch, getPost, getPosts, createPost, updatePost, deletePost, likePost, commentPost, getUser, getPostsByUser, makePurchase, getReservationByUser, updateRating } from '../controllers/post.js' 
