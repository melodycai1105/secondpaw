      ...
      <div className={classes.card}>
        <div className={classes.imageSection}>
          <img className={classes.media} src={post.selectedFile || default_bruin}
            style={{
              height: '450px', width: '450px', borderRadius: '0px',
        ...
        <div className={classes.section} style={{ margin: '40px 0px 0px 40px' }}>
          ...
          <Chip icon={<AutoAwesomeIcon style={{ color: '#6a5acd' }} />} onClick={() => toTag(post.tags)} style={{ fontSize: 12, color: '#6a5acd' }} gutterBottom variant="h6" size="medium" component="h2" label={post.tags.map((tag) => `${tag} `)}></Chip>
